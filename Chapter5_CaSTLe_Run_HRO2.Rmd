---
title: "Automatic_CaSTLe_Classification"
author: "Lisa"
date: "5/19/2021"
...
save(xg, file =paste0(rdata,"CaSTLe_XGBoost_Control2_run_",data_type,".RData") )
...
save(eval_df, file = paste0(rdata,"CaSTLe_Eval_DF_Control2_run_",data_type,".RData"))


# 10. Predict
predictedClasses = predict(xg, ds[!isSource, ])

save(predictedClasses, file = paste0(rdata,"CaSTLe_Annot_output_Control2_",data_type,".RData"))
...
run_CaSTLe(source_data = paste0(rdata,"01_Roska_RefData_Foveal_adult.rds"), 
           target_data = paste0(rdata,"01_HRO_TestData.rds"), 
